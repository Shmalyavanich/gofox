...
<div<?php echo $class; ?> data-uk-slideshow="<?php echo $options; ?>">
    ...
    <div class="<?php echo $position_relative; ?>">
            ...
            <li style="min-height: <?php echo $settings['min_height']; ?>px;">
                ...
                <?php if ($item['media'] && $settings['media']) : ?>
                    ...
                    <?php } else { ?>
						...
						<?php if ($item['content'] && $settings['content']) : ?>
                        <div class="uk-slide-content uk-position-relative uk-container uk-container-center">
                            <div class="<?php echo $content_size; ?> uk-margin"><?php echo $item['content']; ?></div>
                        </div>
                        <?php endif; ?>
                    <?php } ?>
                ...
                <?php elseif(($item['title'] && $settings['title']) || ($item['content'] && $settings['content']) || ($item['media2'])) : ?>
					...
					<?php 
						if ($item['background']){ 
							$background = 'style="background: '.$item['background'].';"';
						} else {
							$background = '';
						}
						if ($item['aligment']){ 
					...
					<div class="uk-slide uk-position-relative" <?php echo $background; ?>>
						<?php if ($item['media2']){ ?>
							<img class="uk-slide-media2 uk-position-absolute uk-media2-aligment-<?php echo $aligment; ?>" src="<?php echo $item['media2']; ?>" alt="" />
						<?php } ?>    
						
						<?php if ($item['content'] && $settings['content']) : ?>
							<div class="uk-slide-content uk-position-absolute">
								<div class="uk-container uk-container-center uk-position-relative uk-flex uk-flex-middle">
									<div class="uk-width-large-1-2 uk-content-aligment-<?php echo $contentAligment; ?>"><?php echo $item['content']; ?></div>
								</div>
							</div>
						<?php endif; ?>
					</div>
        ...
        <?php if ($settings['nav_overlay'] && ($settings['nav'] != 'none')) : ?>
                <div class="uk-slider-nav-wrapper uk-position-absolute uk-flex uk-flex-bottom">
