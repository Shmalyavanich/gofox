	...
	<div class="modal fade" id="modal_form<?php echo $module->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content modal-content-form">
				...
				<form id="form_back_<?php echo $module->id; ?>" name="form" method="post" enctype="multipart/form-data" class="uk-form uk-clearfix" data-captcha="<?php echo $module->id; ?>">
						...
						<?php if ($fields[$i]['type'] != 'separator') { ?>
							...
							<div class="uk-margin-top uk-width-1-1">
								<?php switch ($fields[$i]['type']) {
									case 'text': ?>
										<input class="uk-width-1-1" type="text" name="field<?php echo $i; ?>" placeholder="<?php echo $fields[$i]['placeholder']; ?><?php if ($fields[$i]['required']&&$fields[$i]['placeholder']) { echo ''; } ?>">
										<?php break;

									case 'textarea': ?>
										<textarea class="uk-width-1-1" name="field<?php echo $i; ?>" placeholder="<?php echo $fields[$i]['placeholder']; ?><?php if ($fields[$i]['required']&&$fields[$i]['placeholder']) { echo ''; } ?>"></textarea>
										<?php break;
								} ?>
							</div>
						<?php } else { ?>
					...
					<div class="file">
						...
						<div class="uk-text-center uk-margin-large-top">
							<button class="uk-button btn_form<?php echo $module->id; ?> js-form-send form-send" type="submit" name="submit"><span><?php echo $params->get('button_text'); ?></span></button>
						</div>
					</div>
